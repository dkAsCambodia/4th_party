        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="col-md-6 breadcrumb">
                    ...
                    <li class="breadcrumb-item"> {{ __('messages.All Customer') }} </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12">
                                ...
                                <table id="historyDataTable" style="width: 100% !important">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('messages.Bank Account Name') }}</th>
    ...
    <script>
        $(function () {
            var table = $('#historyDataTable').DataTable({
                ...
                order: [[ 0, "desc" ]],
                ajax: {
                    url: "{{ route('Customer: Get All Customer') }}",
                    data: function (d) {
                        d.status = $('#status').val()
                ...
                columns: [
                    {
                        ...
                        {data: 'bank_account_name', searchable: false, sortable: false},
