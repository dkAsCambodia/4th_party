                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="#" id="exportAgentPaymentDetails" class="btn btn-success btn-sm border-none rounded-1">{{ trans('messages.Export') }}</a>
                        </div>
                        <div class="card-body">
        ...
        <script>
            $(function () {
                var table = $('#paymentDataTable').DataTable({
                    ...
                    order: [[ 0, "desc" ]],
                    ajax: {
                        url: "{{ route('details-payment/list-agent') }}",
                        data: function (d) {
                            d.status = $('#status').val()
                            ...
                            var exportURL = '/agent/export-payment-details?daterange='+d.daterange+'&status='+d.status+'&timezone='+d.timezone;
                            $('#exportAgentPaymentDetails').attr('href', exportURL)
                        },
