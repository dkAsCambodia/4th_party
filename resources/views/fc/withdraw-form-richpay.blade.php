    ...
    <div class="col-md-8">
        <div class="authincation-content">
            <div class="row no-gutters">
                <div class="col-xl-12">
                    <div class="auth-form">
                        <h3 class="text-center mb-4"><b>POIPET RESORT - WITHDRAW FUNDS</b></h3>
                        <form class="form-horizontal" action="{{ route('apiroute.r2p.payout') }}" method="GET" id="paymentForm">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-8">
									<input class="form-control" required name="amount" placeholder="Amount should be minimum 1000.00 in decimal" value="1000.00" type="text">
                                </div>
                            </div>
                            <div class="row mb-2">
