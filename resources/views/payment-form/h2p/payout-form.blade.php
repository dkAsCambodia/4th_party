    ...
    <div class="col-md-8">
        <div class="authincation-content">
            <div class="row no-gutters">
                <div class="col-xl-12">
                    <div class="auth-form">
                        <h3 class="text-center mb-4"><b>Merchant Withdrawal or Payout</b></h3>
                        <form class="form-horizontal" action="{{ route('apiroute.h2p.payout') }}" method="GET" id="paymentForm">
                            <input type="hidden" name="merchant_code" value="testmerchant005">
                            <input type="hidden" name="product_id" value="8">    {{--   for H2p Payout --}}
                            <input type="hidden" name="callback_url" value="{{ route('apiroute.h2pPayoutcallbackURL') }}">
							<div class="row mb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-8">
									<input class="form-control" required name="amount" placeholder="Enter your Amount" value="500" type="text">
                                </div>
                            </div>
                            <div class="row mb-4">
