...
// $apiUrl = "http://127.0.0.1:8000/api/h2p/payout";
$apiUrl = "https://payment.implogix.com/api/h2p/payout";
$data = [
    'merchant_code' => $_GET['merchant_code'], 
    'product_id' => '8',
    'referenceId' => $referenceNo, 
    // 'callback_url' => 'http://127.0.0.1:8000/api/h2p/payout/callbackURL',
    'callback_url' => 'https://payment.implogix.com/api/h2p/payout/callbackURL',
